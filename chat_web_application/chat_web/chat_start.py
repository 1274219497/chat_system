...
from chat_web.handle_data import *
from chat_web.model import *
...
def create_model(session, forward_only, beam_search, beam_size = 5):
    ...
    model_path = 'E:\python_workspace\chatbot_application\save\chat_bot.ckpt-0'
    if forward_only:
...
def decode(sentence):
    with tf.Session() as sess:
        ...
        model.batch_size = 1
        data_path = 'E:\python_workspace\chatbot_application\data\dataset-40000.pkl'
